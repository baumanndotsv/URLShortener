 ...
 */
$GLOBALS['BE_MOD']['system']['URLShortener'] = array
(
    'tables'     => array('tl_urlshortener'),
    'create'     => array('URLShortener', 'generate'),
    'icon'       => 'system/modules/URLShortener/html/icon.png'
);
$GLOBALS['TL_PTY']['error_404'] = 'URLShortener';
